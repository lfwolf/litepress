...
public class ContextConfig {
    ...
    private String moduleName = "cms";  //模块名称

    private String proPackage = "cn.stylefeng.guns.admin";
    private String coreBasePackage = "cn.stylefeng.guns.core";
    private String modelPackageName = "cn.stylefeng.guns.modular.cms.entity";        //model的包名
    private String modelMapperPackageName = "cn.stylefeng.guns.modular.cms.mapper";    //model的dao
    ...
    public void init() {
        ...
        modelPackageName = proPackage + "." + "modular.cms.entity";
        modelMapperPackageName = proPackage + "." + "modular.cms.mapper";
    }
