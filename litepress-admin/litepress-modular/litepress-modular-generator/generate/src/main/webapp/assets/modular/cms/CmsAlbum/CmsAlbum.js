layui.use(['layer', 'form', 'table', 'admin', 'ax'], function () {
    ...
    CmsAlbum.initColumn = function () {
        return [[
            ...
            {title: '版本（乐观锁保留字段）', field: 'version', sort: true},
            {title: '排序', field: 'sort', sort: true},
            {title: '状态', field: 'status', sort: true},
            {title: '创建时间', field: 'createTime', sort: true},
            {title: '修改时间', field: 'updateTime', sort: true},
            {title: '创建人', field: 'createUser', sort: true},
            {title: '修改人', field: 'updateUser', sort: true}
